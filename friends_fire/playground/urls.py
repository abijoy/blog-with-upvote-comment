...
urlpatterns = [
	...
	path('accounts/login/', auth_views.login, {'template_name': 'playground/login.html'}, name='login'),
	path('accounts/logout/', auth_views.logout, {'template_name': 'playground/logout.html'}, name='logout'),
